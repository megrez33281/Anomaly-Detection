...
* 作法
    ...
    這再次證明了AutoEncoder並不適合在當前資料集上以通用形式建立，因為各個種類的特徵相差實在太大，這似乎導致這些特徵被柔和在一起，變成一整塊色塊  
...
* 結論  
    考慮到如果要真的建立一個通用的AutoEncoder可能要經歷多次調整，加上訓練一次AutoEncoder的耗時過長  
    我決定暫時轉換路線，嘗試將U-Net變成一個特徵抽取器，
