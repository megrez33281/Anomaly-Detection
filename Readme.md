...
| SSIM_WEIGHT| Epoch 1 | Epoch 2  | Epoch 3 | Epoch 4 | Epoch 5 | 特別說明 | 
| :--- | :--- | :--- | :--- |:--- | :--- | :--- | 
| 0.8 | 0.8841 | 0.9322 | 0.9311 | 0.9238 | 0.9168 | |
| 0.5 | 0.5478 | 0.7298 | 0.9093 | 0.9066 | 0.9376 | |
| 0.1 | 0.7382 | 0.7686 | 0.7703 | 0.7696 | 0.7725 | |
| 0.0 | 0.0920 | 0.0425 | 0.0319 | 0.0259 | 0.0216 | 此SSIM_WEIGHT相當於只使用L1作為Loss，意外發現重建能力與L1+VGG相似，或許可嘗試去掉跳接層後嘗試異常重建| 

![只用L1](/視覺化資料對比/模型能力驗證_通用_L1/summary_22_epochs_1-5.png)  


分別取各個SSIM_WEIGHT下視覺效果最好的Epoch的權重進行分群測試
| 模型 (SSIM 權重) | 使用第幾Epoch的權重| 主要混淆情況  |
| :--- | :--- | :--- |
│ 0.5 | 1 │ 主要在「鐵網」和「磁磚」之間，榛果和牙刷被分到一起│
│ 0.8 | 3 │ 「皮革」和「鐵網」嚴重混淆 (純度僅59%) │
│ 0.0 | 5 │ 結構類物體完美分類，紋理類物體，鐵網-磁磚、木板-地毯-皮革混淆│
